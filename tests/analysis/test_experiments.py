...
_ = OrderedDict([
        ...
        ('SigA', [1.882350488972039e-09, 1.9788587163647553e-08,
        ...
        ('SigB', [1.5480323625508021e-12, 1.54803236255134e-12,
...
def test_mass_transfer(df_01):
    ...
    pd.testing.assert_fragit bme_equal(df_res, RES_DF, check_dtype=False)
