...
RES_DF_STATS = pd.DataFrame(dict(
    ...
    A=[1099, 108.65435020000001, 2.9115952811878664e-10, 0.09886656069153778,
       0.0988204, 0.0988892],
    SigA=[1099, 2.8479658233e-5, 1.6799225077158573e-14, 2.5914156717925386e-8,
          5.7542e-10, 2.31568e-6],
    B=[1099, -3.3916213899999997e-6, 1.0192229310327573e-18,
       -3.0860977161055502e-9, -6.39227e-9, -1.33072e-9],
    SigB=[1099, 1.7167221368e-9, 3.64306158289e-23, 1.5620765576e-12,
...
BEST_FIT_STATS_DF = pd.DataFrame(dict(
    ...
    SpaldMdpp=[15, 6.891970610922726e-5, 3.374503537606972e-12,
               4.594647073948485e-6, 1.667680180617026e-6,
               7.657000423932914e-6],
    SpaldMdppUnc=[15, 1.4023587162625972e-6, 6.529045232292923e-16,
                  9.349058108417315e-8, 5.540884373544941e-8,
                  1.3541892940338585e-7],
