...
def test_set_local_properties(anlys_eng, sample):  # noqa: D103
    ...
    assert isclose(result['hfg'].nominal_value, 2463995.459)
    assert isclose(result['hu'].nominal_value, -2463995.459)
    assert isclose(result['hs'].nominal_value, 0)
    assert isclose(result['cpv'].nominal_value, 1014.5270579)
    assert isclose(result['he'].nominal_value, 1348.737634)
    assert isclose(result['cpl'].nominal_value, 4187.515626)
    assert isclose(result['hT'].nominal_value, 5566.987961)
    assert isclose(result['qcu'].nominal_value, 68.46389159)
    assert isclose(result['Ebe'].nominal_value, 401.3453444)
    assert isclose(result['Ebs'].nominal_value, 394.0376841)
    assert isclose(result['qrs'].nominal_value, 7.210491646)
    assert isclose(result['kv'].nominal_value, 0.0255848377)
    assert isclose(result['alpha'].nominal_value, 2.104420756e-05)
    assert isclose(result['Bh'].nominal_value, -0.00507699306)
    assert isclose(result['M'].nominal_value, 28.8579850)
    assert isclose(result['gamma1'].nominal_value, 0.5022594719)
    assert isclose(result['beta'].nominal_value, 0.003455569646)
    assert isclose(result['Delta_m'].nominal_value, 0.00286996475)
    assert isclose(result['Delta_T'].nominal_value, -1.329425)
    assert isclose(result['mu'].nominal_value, 1.794143889e-05)
    assert isclose(result['nu'].nominal_value, 1.49716896e-05)
    ...
    assert isclose(result['hfg'].std_dev, 1126.860038)
    assert isclose(result['hu'].std_dev, 1126.860038)
    assert isclose(result['hs'].std_dev, 0)
    assert isclose(result['cpv'].std_dev, 0.002956749426)
    assert isclose(result['he'].std_dev, 251.9469741)
    assert isclose(result['cpl'].std_dev, 0.1216812541)
    assert isclose(result['hT'].std_dev, 1039.924855)
    assert isclose(result['qcu'].std_dev, 1.138524024)
    assert isclose(result['Ebe'].std_dev, 0.1565338681)
    assert isclose(result['Ebs'].std_dev, 1.346873806)
    assert isclose(result['qrs'].std_dev, 1.337909842)
    assert isclose(result['kv'].std_dev, 9.186775478e-06)
    assert isclose(result['alpha'].std_dev, 1.181578989e-08)
    assert isclose(result['Bh'].std_dev, 8.26715095e-05)
    assert isclose(result['M'].std_dev, 0.001013006621)
    assert isclose(result['gamma1'].std_dev, 0.0002218153945)
    assert isclose(result['beta'].std_dev, 1.4827052243e-06)
    assert isclose(result['Delta_m'].std_dev, 0.000185040939)
    assert isclose(result['Delta_T'].std_dev, 0.24833933421832313)
    assert isclose(result['mu'].std_dev, 5.968184047e-09)
    assert isclose(result['nu'].std_dev, 8.158787725e-09)
...
def test_set_nondim_groups(anlys_eng, sample):  # noqa: D103
    ...
    assert isclose(result['NuR'].nominal_value, -3.239682362)
    assert isclose(result['Le'].nominal_value, 1.165191723)
    assert isclose(result['GrR_binary'].nominal_value, -423.4062806)
    assert isclose(result['GrR_primary'].nominal_value, 427.0226524)

    assert isclose(result['ShR'].std_dev, 0.3206133366)
    assert isclose(result['NuR'].std_dev, 0.06555358581)
    assert isclose(result['Le'].std_dev, 0.001321978489)
    assert isclose(result['GrR_binary'].std_dev, 128.377472)
    assert isclose(result['GrR_primary'].std_dev, 127.9778022)
