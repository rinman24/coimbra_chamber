...
solution = dict(
    ...
    Gr_mR=un.ufloat(440.4259521265484, 5.803839106068267),
    ...
    alpha=un.ufloat(2.0609713384502823e-05, 6.457597985480573e-09),
    nu=un.ufloat(1.4781489909580254e-05, 2.8895414401069612e-09),
    )
