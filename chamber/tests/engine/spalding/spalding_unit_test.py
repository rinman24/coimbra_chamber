...
def test_spalding_constructor(spald):  # noqa: D103
    ...
    assert math.isclose(
        spald.film_props['beta'], const.initial_film_props['beta'])
    assert math.isclose(
        spald.film_props['gamma_1'], const.initial_film_props['gamma_1'])
...
def test_update_model(spald):  # noqa: D103
    ...
    assert math.isclose(
        spald.film_props['beta'], const.updated_film_props['beta'])
    assert math.isclose(
        spald.film_props['gamma_1'], const.updated_film_props['gamma_1'])
...
def test_solve_model(spald):  # noqa: D103
    ...
    assert math.isclose(
        spald.solution['Sh_L'].nominal_value,
        const.solution['Sh_L'].nominal_value)
    assert math.isclose(
        spald.solution['Nu_L'].nominal_value,
        const.solution['Nu_L'].nominal_value)
    ...
    assert _compare_ufloats(spald.solution['nu'], const.solution['nu'])
