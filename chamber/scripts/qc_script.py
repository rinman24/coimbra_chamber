...
This script plots the experimental data for a man-in-the-loop QC visual
inspection.
...
def get_tdms_obj(file_path):
    """Return the npTDMS object coresponding to the argument file."""
...
def get_t_data(tdms_obj):
    """Get the temperature data of the thermocouples."""
