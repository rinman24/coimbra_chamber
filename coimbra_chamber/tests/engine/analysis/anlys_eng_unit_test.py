...
def test_set_local_exp_state(anlys_eng, sample):  # noqa: D103
    ...
    assert isclose(result['Te'].nominal_value, 290)  # Rounded to nearest 5.
...
def test_set_local_properties(anlys_eng, sample):  # noqa: D103
    ...
    assert isclose(result['rhoe'].nominal_value, 1.196843130, **TOL)
    assert isclose(result['rho'].nominal_value, 1.1984665106, **TOL)
    assert isclose(result['Bm1'].nominal_value, 0.002902230588, **TOL)
    assert isclose(result['T'].nominal_value, 289.3615875, **TOL)
    assert isclose(result['D12'].nominal_value, 2.451678162e-05, **TOL)
    ...
    assert isclose(result['he'].nominal_value, 1295.37271386, **TOL)
    assert isclose(result['cpl'].nominal_value, 4187.515626, **TOL)
    assert isclose(result['hT'].nominal_value, 5346.757759, **TOL)
    assert isclose(result['qcu'].nominal_value, 68.45778612, **TOL)
    assert isclose(result['Ebe'].nominal_value, 401.0542934, **TOL)
    assert isclose(result['Ebs'].nominal_value, 394.0376841, **TOL)
    assert isclose(result['qrs'].nominal_value, 6.923310721, **TOL)
    assert isclose(result['kv'].nominal_value, 0.0255828917, **TOL)
    assert isclose(result['alpha'].nominal_value, 2.104070865e-05, **TOL)
    assert isclose(result['Bh'].nominal_value, -0.00507834675, **TOL)
    assert isclose(result['M'].nominal_value, 28.8579850, **TOL)
    assert isclose(result['gamma1'].nominal_value, 0.5022138536, **TOL)
    assert isclose(result['gamma2'].nominal_value, -0.0030540967, **TOL)
    assert isclose(result['beta'].nominal_value, 0.003455883722, **TOL)
    assert isclose(result['Delta_m'].nominal_value, 0.00286996475, **TOL)
    assert isclose(result['Delta_T'].nominal_value, -1.276825, **TOL)
    assert isclose(result['mu'].nominal_value, 1.7940174646e-05, **TOL)
    assert isclose(result['nu'].nominal_value, 1.4969274892e-05, **TOL)
    ...
    assert isclose(result['rhoe'].std_dev, 0.000117064257, **TOL)
    ...
    assert isclose(result['D12'].std_dev, 2.4171915532e-08, **TOL)
    ...
    assert isclose(result['cpv'].std_dev, 0.00295332657, **TOL)
    assert isclose(result['he'].std_dev, 251.9469741, **TOL)
    assert isclose(result['cpl'].std_dev, 0.12195510975, **TOL)
    assert isclose(result['hT'].std_dev, 1039.924855, **TOL)
    assert isclose(result['qcu'].std_dev, 1.138422639, **TOL)
    assert isclose(result['Ebe'].std_dev, 0.156448723, **TOL)
    assert isclose(result['Ebs'].std_dev, 1.346873806, **TOL)
    assert isclose(result['qrs'].std_dev, 1.337909842, **TOL)
    assert isclose(result['kv'].std_dev, 9.187055637e-06, **TOL)
    assert isclose(result['alpha'].std_dev, 1.181373838e-08, **TOL)
    assert isclose(result['Bh'].std_dev, 8.269314258e-05, **TOL)
    assert isclose(result['M'].std_dev, 0.001013006621, **TOL)
    assert isclose(result['gamma1'].std_dev, 0.0002217769943, **TOL)
    assert isclose(result['gamma2'].std_dev, 2.92126140413e-05, **TOL)
    assert isclose(result['beta'].std_dev, 1.48297476189e-06, **TOL)
    ...
    assert isclose(result['nu'].std_dev, 8.15736362472e-09, **TOL)
    ...
    assert isclose(result['rhoe'], 1.19684313, **TOL)
    assert isclose(result['rho'], 1.198466511, **TOL)
    assert isclose(result['Bm1'], 0.002902230588, **TOL)
    assert isclose(result['T'], 289.3615875, **TOL)
    assert isclose(result['D12'], 2.451678162e-05, **TOL)
    ...
    assert isclose(result['he'], 1295.37271386, **TOL)
    assert isclose(result['cpl'], 4187.515626, **TOL)
    assert isclose(result['hT'], 5346.7577586, **TOL)
    assert isclose(result['qcu'], 68.457786125, **TOL)
    assert isclose(result['Ebe'], 401.05429341, **TOL)
    assert isclose(result['Ebs'], 394.0376841, **TOL)
    assert isclose(result['qrs'], 6.923310721, **TOL)
    assert isclose(result['kv'], 0.0255828917, **TOL)
    assert isclose(result['alpha'], 2.1040708654e-05, **TOL)
    assert isclose(result['Bh'], -0.00507834675, **TOL)
    assert isclose(result['M'], 28.8579850, **TOL)
    assert isclose(result['gamma1'], 0.5022138536, **TOL)
    assert isclose(result['gamma2'], -0.003054096723, **TOL)
    assert isclose(result['beta'], 0.003455883722, **TOL)
    assert isclose(result['Delta_m'], 0.00286996475, **TOL)
    assert isclose(result['Delta_T'], -1.276825, **TOL)
    assert isclose(result['mu'], 1.79401746461e-05, **TOL)
    assert isclose(result['nu'], 1.496927489169e-05, **TOL)
    ...
    assert isclose(result['sig_rhoe'], 0.0001170642573, **TOL)
    ...
    assert isclose(result['sig_D12'], 2.417191553197e-08, **TOL)
    ...
    assert isclose(result['sig_cpv'], 0.00295332657, **TOL)
    assert isclose(result['sig_he'], 251.9469741, **TOL)
    assert isclose(result['sig_cpl'], 0.1219551098, **TOL)
    assert isclose(result['sig_hT'], 1039.924855, **TOL)
    assert isclose(result['sig_qcu'], 1.138422639, **TOL)
    assert isclose(result['sig_Ebe'], 0.15644872295, **TOL)
    assert isclose(result['sig_Ebs'], 1.346873806, **TOL)
    assert isclose(result['sig_qrs'], 1.337909842, **TOL)
    assert isclose(result['sig_kv'], 9.1870556375e-06, **TOL)
    assert isclose(result['sig_alpha'], 1.181373838e-08, **TOL)
    assert isclose(result['sig_Bh'], 8.269314258e-05, **TOL)
    assert isclose(result['sig_M'], 0.001013006621, **TOL)
    assert isclose(result['sig_gamma1'], 0.000221776994, **TOL)
    assert isclose(result['sig_gamma2'], 2.921261404126e-05, **TOL)
    assert isclose(result['sig_beta'], 1.48297476189e-06, **TOL)
    ...
    assert isclose(result['sig_nu'], 8.1573636247e-09, **TOL)
...
def test_set_nondim_groups(anlys_eng, sample):  # noqa: D103
    ...
    assert isclose(result['ShR'].nominal_value, 4.8836103126, **TOL)
    assert isclose(result['NuR'].nominal_value, -3.23906095724, **TOL)
    assert isclose(result['Le'].nominal_value, 1.165207029, **TOL)
    assert isclose(result['GrR_binary'].nominal_value, -396.74581492, **TOL)
    assert isclose(result['GrR_primary'].nominal_value, 400.28166996, **TOL)

    assert isclose(result['ShR'].std_dev, 0.320633318, **TOL)
    assert isclose(result['NuR'].std_dev, 0.06554083131, **TOL)
    assert isclose(result['Le'].std_dev, 0.00132204227, **TOL)
    assert isclose(result['GrR_binary'].std_dev, 128.38489724, **TOL)
    assert isclose(result['GrR_primary'].std_dev, 127.96203587, **TOL)

    # Then the fit ...........................................................
    result = anlys_eng._this_fit

    assert isclose(result['ShR'], 4.8836103126, **TOL)
    assert isclose(result['NuR'], -3.239060957, **TOL)
    assert isclose(result['Le'], 1.16520702894, **TOL)
    assert isclose(result['GrR_binary'], -396.7458149, **TOL)
    assert isclose(result['GrR_primary'], 400.28166996, **TOL)

    assert isclose(result['sig_ShR'], 0.3206333177, **TOL)
    assert isclose(result['sig_NuR'], 0.0655408313, **TOL)
    assert isclose(result['sig_Le'], 0.00132204227, **TOL)
    assert isclose(result['sig_GrR_binary'], 128.38489724, **TOL)
    assert isclose(result['sig_GrR_primary'], 127.96203587, **TOL)
